odoo.define('odoo_stock_availability.VariantMixin', function (require) {
'use strict';
...
VariantMixin._onChangeCombinationStock = function (ev, $parent, combination) {
    ...
    $parent.find('.sh_add_cart').removeAttr('disabled');
    ...
    if (combination.product_type === 'product' && _.contains(['always', 'threshold'], combination.inventory_availability)) {
        ...
        if (qty > combination.virtual_available
            ...
            $parent.find('.sh_add_cart').attr('disabled', true);
